                                                ...
                                                <tbody>
                                                    <?php foreach ($datapemesanan as $pemesanan) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $pemesanan['telp_pengirim']; ?></td>
                                                            <td><?= $pemesanan['alamat_pengirim']; ?></td>
                                                            <td><?= $pemesanan['keterangan_pengirim']; ?></td>
                                                            <td><?= $pemesanan['jenis_barang']; ?></td>
                                                            <td><?= $pemesanan['berat']; ?>KG</td>
                                                            <td><?= $pemesanan['tanggal_kirim']; ?></td>
                                                            <td><?= $pemesanan['jam']; ?></td>
                                                            <td><?= $pemesanan['nama_tarif']; ?></td>
                                                            <td><?= $pemesanan['nama_metode']; ?></td>
                                                            <td><?= $pemesanan['harga_barang']; ?></td>
                                                            <td><?= $pemesanan['ongkir']; ?></td>
                                                            <td><?= $pemesanan['kode_diskon']; ?></td>
                                                            <td><?= $pemesanan['total_harga']; ?></td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="/orderedit/<?= $pemesanan['id_pemesanan']; ?>"><i class="bx bx-edit-alt mr-1"></i> ubah</a>
                                                                        <a class="dropdown-item" href="/deleteorder/<?= $pemesanan['id_pemesanan']; ?>"><i class="bx bx-trash mr-1"></i> hapus</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
