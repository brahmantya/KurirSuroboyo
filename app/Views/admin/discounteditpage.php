                                ...
                                <ul class="nav nav-tabs mb-2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                            <i class="bx bx-user mr-25"></i><span class="d-none d-sm-block">Tambah Data Diskon</span>
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" value="001" required data-validation-required-message="Id diskon harus diisi">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Kode Diskon</label>
                                                            <input type="number" class="form-control" value="KSMERDEKA" required data-validation-required-message=" Kode diskon harus diisi">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" aria-describedby="basic-addon2" value="17">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" aria-describedby="basic-addon1" value="17000">
                                                        </div>
                                                    </fieldset>
                                                </div>
