                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">Data Tarif</h2>
                                </div>
                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Min Ongkir</th>
                                                        <th>Max Berat</th>
                                                        <th>Biaya Ekstra Banyak Penerima</th>
                                                        <th>Biaya Ekstra Berat Maksimal</th>
                                                        <th>Aksi</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php foreach ($datatarif as $tarif) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $tarif['tarif']; ?></td>
                                                            <td><?= $tarif['hitungan']; ?></td>
                                                            <td><?= $tarif['minim_ongkir']; ?></td>
                                                            <td><?= $tarif['max_berat']; ?></td>
                                                            <td><?= $tarif['extracostpenerima']; ?></td>
                                                            <td><?= $tarif['extracostberat']; ?></td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="/rateedit/<?= $tarif['id_tarif']; ?>"><i class="bx bx-edit-alt mr-1"></i> ubah</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
