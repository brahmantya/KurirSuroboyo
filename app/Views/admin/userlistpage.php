                                                ...
                                                <tbody>
                                                    <?php foreach ($datauser as $user) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $user['no_telp']; ?></td>
                                                            <td><?= $user['alamat_pengirim']; ?></td>
                                                            <td><?= $user['keterangan_pengirim']; ?></td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="/useredit/<?= $user['username']; ?>"><i class="bx bx-edit-alt mr-1"></i> ubah</a>
                                                                        <a class="dropdown-item" href="/deleteuser/<?= $user['username']; ?>"><i class="bx bx-trash mr-1"></i> hapus</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
