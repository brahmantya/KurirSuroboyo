                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" id="id_diskon" name="id_diskon" required data-validation-required-message="Id diskon harus diisi" value="<?= (isset($dataupdate['id_diskon'])) ? $dataupdate['id_diskon']  : $id_diskon ?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Kode Diskon</label>
                                                            <input type="text" class="form-control" id="kode_diskon" name="kode_diskon" required data-validation-required-message=" Kode diskon harus diisi" value="<?= (isset($dataupdate)) ? $dataupdate['kode_diskon']  : '' ?>">
                                                        </div>
                                                    </div>
                                                    <fieldset>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="max_diskon" name="max_diskon" class="form-control" aria-describedby="basic-addon1" value="<?= (isset($dataupdate)) ? $dataupdate['max_diskon']  : '' ?>">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="potongan" name="potongan" aria-describedby="basic-addon2" value="<?= (isset($dataupdate)) ? $dataupdate['potongan']  : '' ?>">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="custom-select" id="satuan" name="satuan">
                                                                <?php $datasatuan = ['Persen', 'Rp']; ?>
                                                                <?php foreach ($datasatuan as $satuan) : ?>
                                                                    <?php if (isset($dataupdate) && $dataupdate['satuan'] == $satuan) : ?>
