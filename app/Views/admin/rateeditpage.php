...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/validation/form-validation.css">
    <link rel="stylesheet" type="text/css" href="css/select/select2.min.css">
    <link rel="stylesheet" type="text/css" href="css/pickadate/pickadate.css">
    <link rel="stylesheet" type="text/css" href="css/animate/animate.css">
    <link rel="stylesheet" type="text/css" href="css/extensions/sweetalert2.min.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="css/page-users.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right pb-0"><a class="dropdown-item" href="/"><i class="bx bx-power-off mr-50"></i> Keluar</a>
                            </div>
                        </li>
                    </ul>
                </div>
                                ...
                                <ul class="nav nav-tabs mb-2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                            <i class="bx bx-user mr-25"></i><span class="d-none d-sm-block">Ubah Data Tarif</span>
                                        </a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" value="001" required data-validation-required-message="Id tarif harus diisi">
                                                        </div>
                                                    </div>
                                                    <fieldset>
                                                        ...
                                                        <div class="input-group" required="">
                                                            ...
                                                            <input type="text" class="form-control" aria-describedby="basic-addon1" value="10000" required data-validation-required-message="Harga tarif harus diisi">
                                                        </div>
                                                    </fieldset>
                                                    <fieldset class="form-group">
                                                        <label>Satuan</label>
                                                        <select class="custom-select" id="customSelect" required="">
                                                            <option selected>Pilih satuan</option>
                                                            <option value="1">Se-Surabaya</option>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Nama</label>
                                                            <input type="text" class="form-control" value="Flat" required data-validation-required-message="Nama harus diisi">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <fieldset>
                                                            ...
                                                            <div class="input-group" required="">
                                                                ...
                                                                <input type="text" class="form-control" aria-describedby="basic-addon1" value="10000" value="10000" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="Hanya bisa diisi dengan angka" required data-validation-required-message="Min ongkir harus diisi">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="form-group">
                                                        <fieldset>
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" aria-describedby="basic-addon2" value="3" required data-validation-required-message="Max berat harus diisi">
                                                ...
                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                                    <button type="button" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1" id="type-success">Simpan</button>
    ...
    <script src="js/forms/select2.full.min.js"></script>
    ...
    <script src="js/extensions/polyfill.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <script src="js/extensions/sweet-alerts.js"></script>
    <!-- END: Page JS-->
