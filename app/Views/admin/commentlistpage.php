...
<head>
    ...
    <link rel="apple-touch-icon" href="<?= base_url() ?>/<?= base_url() ?>/ico/logokotak.ico">
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/css/datatable/datatables.min.css">
    <!-- END: Vendor CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                                    ...
                                    <div class="card-body card-dashboard">
                                        <div class="table-responsive">
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    <?php foreach ($kritiksarandata as $data) : ?>
                                                        <tr>
                                                            <td><?= $data['id_kritik']; ?></td>
                                                            <td><?= $data['nama']; ?></td>
                                                            <td><?= $data['email']; ?></td>
    ...
    <script src="<?= base_url() ?>/js/datatable/datatables.min.js"></script>
    <script src="<?= base_url() ?>/js/datatable/dataTables.bootstrap4.min.js"></script>
    ...
    <script src="<?= base_url() ?>/js/datatable/buttons.bootstrap.min.js"></script>
