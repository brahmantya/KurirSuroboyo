                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <div class="invoice-create-btn mb-1">
                                            <a href="/discountadd" class="btn btn-primary glow invoice-create" role="button" aria-pressed="true">Tambah Data</a>
                                        </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($diskonlist as $diskon) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $diskon['satuan']; ?></td>
                                                            <td><?= $diskon['max_diskon']; ?></td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="/discountedit/<?= $diskon['id_diskon']; ?>"><i class="bx bx-edit-alt mr-1"></i> ubah</a>
                                                                        <a class="dropdown-item" href="/discountdelete/<?= $diskon['id_diskon']; ?>"><i class="bx bx-trash mr-1"></i> hapus</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
